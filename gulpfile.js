...
let path = {
    ...
    build:{
        html: project_folder +"/",
        css: project_folder + "/assets/fincentre/css/",
        js: project_folder +"/assets/fincentre/js/",
        img: project_folder +"/assets/fincentre/img/",
        image: project_folder +"/assets/fincentre/image/",
        fonts: project_folder +"/assets/fincentre/fonts/"
    },
    //исходники
    src:{
        html: [source_folder +"/*.html", "!" + source_folder +"/_*.html"],
        scss: source_folder +"/assets/fincentre/scss/style.scss",
        js: source_folder +"/assets/fincentre/js/script.js",
        img: source_folder +"/assets/fincentre/img/**/*.{jpg,png,svg,gif,ico,webp}",
        image: source_folder +"/assets/fincentre/image/**/*.{jpg,png,svg,gif,ico,webp}",
        fonts: source_folder + "/assets/fincentre/fonts/**/*.{eot,ttf,woff,woff2,svg}"
    },
    // пути папок за которыми нужно будет следить
    watch:{
        html: source_folder +"/**/*.html",
        scss: source_folder +"/assets/fincentre/scss/**/*.scss",
        js: source_folder +"/assets/fincentre/js/**/*.js",
        img: source_folder +"/assets/fincentre/img/**/*.{jpg,png,svg,gif,ico,webp}",
        image: source_folder +"/assets/fincentre/image/**/*.{jpg,png,svg,gif,ico,webp}",
        fonts: source_folder + "/assets/fincentre/fonts/**/*.{eot,ttf,woff,woff2,svg}"
    },
